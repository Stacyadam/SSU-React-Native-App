...
class RequestCardForm extends Component {
	...
	render() {
		return (
			...
			>
				<Text style={{ fontFamily: 'Omnes-Regular', marginTop: 30, marginBottom: 20, fontSize: 22 }}>
					REQUEST A CARD
				</Text>
				<Image
				...
				<View style={{ paddingHorizontal: 12 }}>
					<Text style={{ fontFamily: 'Omnes-Regular', textAlign: 'center', fontSize: 16, marginBottom: 10 }}>
				...
				<View style={{ width: 240 }}>
					...
					{this.state.errors && this.state.errors.address_line_1 ? (
						...
						<Text style={{ fontFamily: 'Omnes-Regular', fontSize: 14, marginBottom: 6 }}>Address 1</Text>
					)}
					<TextInput
						style={{
							borderColor: orange,
					...
					<View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 10 }}>
						<View style={{ flex: 2, marginRight: 6 }}>
							{this.state.errors && this.state.errors.city ? (
								...
								<Text style={{ fontFamily: 'Omnes-Regular', fontSize: 14, marginBottom: 6 }}>City</Text>
							)}
							<TextInput
								style={{
									borderColor: orange,
